...
INSERT INTO category(categoryID,categoryName,parentID) values(5,'cloths',NULL);
...
INSERT INTO product(productID,productName,price,stocks,categoryID,description) values(1,'Ball',50,15,1,'This is a Ball');
INSERT INTO product(productID,productName,price,stocks,categoryID,description) values(2,'Bat',1000,10,1,'This is a Bat');
INSERT INTO product(productID,productName,price,stocks,categoryID,description) values(3,'Badinton',200,20,2,'This is a Badminton');
INSERT INTO product(productID,productName,price,stocks,categoryID,description) values(4,'TShirt',500,30,3,'This is a TShirt');
INSERT INTO product(productID,productName,price,stocks,categoryID,description) values(5,'Cap',100,20,4,'This is a Cap');
INSERT INTO product(productID,productName,price,stocks,categoryID,description) values(6,'Shoe',1500,10,5,'This is a Shoe');
...
INSERT INTO orders(orderID,shippingAddress,orderDate,deliveryDate,totalBill,userID,productID) values(6,'pqr','2020-7-09','2020-7-17',1290,3,4);
